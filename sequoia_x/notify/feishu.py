...
class FeishuNotifier:
    ...
    # 策略的中文大白话含义说明书，100% 防止飞书客户端过滤
    STRATEGY_DESCRIPTIONS = {
        "CbComboV6UltimateStrategy": "双指标合击版：高阶左侧筑底策略。利用威廉恐慌指标捕捉市场恐慌砸盘的底部，在0轴下方金叉时右侧安全介入，并以快线跌破0轴作为清仓熔断止损线。"
        "MaVolumeStrategy": "均线成交量突破：量价齐升动量策略。监控价格均线向上突破并伴随成交量爆量放大，捕获大资金强力扫货个股。",
        ...
        "RpsBreakoutStrategy": "股价相对强度RPS突破：欧奈尔基本面技术龙头策略。筛选一段时间内涨幅超越市场绝大数股票、且出现图形突破的核心题材龙头。",
        "PrivatePlacementStrategy": "定向增发套利：事件驱动型基本面策略。监控发布定增公告后股价跌至定增价附近的个股，利用大股东和机构的成本线作为天然安全边际套利。"
    }
        ...
        return {
            ...
            "card": {
                ...
                "elements": [
                    ...
                    # 在日期下方直接硬编码插入高亮的策略释义，免去飞书对鼠标悬停的过滤
                    {
                        "tag": "div",
                        "text": {
                            "tag": "lark_md",
